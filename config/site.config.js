...
module.exports = {
  ...
  footer:
    'Powered by <a href="https://github.com/lukaskronus/onedrive-cf-index-ng" target="_blank" rel="noopener noreferrer">OneDrive Indexer</a>. Made with ❤.',
  ...
  protectedRoutes: ['/DTS Courses','/School Materials','/Images/Misc','/Others','/Temp','/Ebooks/Requested/Anh Thuyen Ebooks'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:triphan@ubytxh.vn',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/lukaskronus',
    },
  ],
